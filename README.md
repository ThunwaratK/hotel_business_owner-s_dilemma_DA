...
**Results:**
- Direct channel revenue after marketing costs is only about 33% of total revenue.
...
**Results:**
- Running promotions through OTA reduces commission by about $5 per booking versus OTA Only, but Net ADR drops from $256.41 to $231.94 (down about $24.47), indicating Net ADR per booking decreases.
...
- Reduce advertising spend to align with direct website revenue.
